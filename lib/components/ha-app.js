...
export class HackpalachiaApp extends LitElement {
    ...
    render() {
      ...
      if (isEventEnded) {
        rightPaneContent = html`<p class="timer">The event has ended</p><p>Thank you for participating!</p><ha-credits></ha-credits>`;
      } else {
        rightPaneContent = html`<p class="timer">Time until submission: ${timeLeft}</p>
